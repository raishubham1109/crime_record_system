	...
	<body class="inves">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="show_accused.php">Accused for a record</a></li>
			 ...
			 <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Update record<span class="caret"></span></a>
        <ul class="dropdown-menu">
		...
		<h1> ENTER THE CRIME NAME TO FIND THE ACCUSED</h1>
		
		<br><br>
		
	<form action="showaccused.php" method="POST">
		<div class="container">
			...
			<div class="row">	
			 ...
			 <div class="row">
				  <div class="col-lg-offset-4 ">
					<button type="submit"  class="btn  navbar-inverse" value="submit" style="width:50%;color:white">SUBMIT
					</button>
