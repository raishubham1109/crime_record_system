...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>                 
  ...
  <script src="https://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
	...
	<form action="accused_status_update.php" method="POST">
		<div class="container">
			<div class="row">
			...
			<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">Accused_id </strong>
						<input type="text" placeholder ="accused_id"  class="form-control input-mid"   name="accused_id"  required>
					</div>
					</div>
			...
			<div class="row">	
		     ...
		     <div class="row">
				  <div class="col-lg-offset-4 ">
					<button type="submit"  class="btn  navbar-inverse" value="submit" style="width:50%">Update Record</button>
                   </div>
			<div>			
<br>				   
