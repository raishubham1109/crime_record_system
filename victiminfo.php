...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>                 
  ...
  <script src="https://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
	...
	<nav class="navbar navbar-inverse">
		...
		<h1 align="center"class="colo"> VICTIM -RECORD</h1>
		<br><br>
		
	<form action="victim_insert.php" method="POST">
		<div class="container">
			<div class="row">
			<div class="col-lg-offset-1 col-md-4">
			<div class="formgroup">
			<strong class="colo"> Crime-Name </strong>
			<input type="text" placeholder ="crime_name"  class="form-control input-mid" id="CRIME"  name="crime_name"  required>
					</div>
			...
			<div class="row">	
				<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						...
						<input type="text" placeholder ="first_name"  class="form-control input-mid"name="fname"  required>
					</div>
				</div>
				<div class="col-lg-offset-2 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
			...
			<div class="row">	
				<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">Victim Id</strong>
						<input type="text" placeholder ="Id"  class="form-control input-mid" name="victim-id"   required>
					</div>
				</div>
				<div class="col-lg-offset-2 col-md-4">
					<div class="formgroup">
						<select class="select" style="width:100%;height:5%"id="signup-motivation" name="gender">
			...
			<div class="row">	
				<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						...
						<input type="number" placeholder ="age"  class="form-control input-mid" name="age"  required>
					</div>
				</div>
				<div class="col-lg-offset-2 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">Contact-no</strong>
						<input type="nummber" placeholder ="number" name="phones"class="form-control input-mid"   required>
					</div>
				</div>
			</div>
			...
			<div class="row">	
				<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">Condition(losses)</strong>
						<input type="text" placeholder ="condition"  class="form-control input-mid" name="loss"  required>
					</div>
				</div>
				<div class="col-lg-offset-2 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">House-no</strong>
						<input type="text" placeholder ="house no" class="form-control input-mid"  name="house" required>
					</div>
				</div>
				<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">City</strong>
						<input type="text" placeholder ="City" name="city" class="form-control input-mid"   required>
					</div>
				</div>
				<div class="col-lg-offset-2 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						<strong class="colo">Street</strong>
						<input type="text" placeholder ="street" class="form-control input-mid" name="street" required>
					</div>
				</div>
				</div>
				<div class="row">
			<div class="col-lg-offset-1 col-md-4">
					<div class="form-group">  <!--needed for optimum spacing-->
						...
						<input type="text" placeholder ="pincode" class="form-control input-mid" name="pincode" required>
					</div>
				</div>
				</div>
